  ...
  return {
    ...
    async closeBundle() {
      await Promise.all([
        ...
        esbuild({entryPoints:[resolve(root,"content/xingtu-content.js")],outfile:resolve(outputDirectory,"content/xingtu-content.js"),bundle:true,format:"iife",platform:"browser",target:"chrome120",legalComments:"none"}),
        esbuild({
