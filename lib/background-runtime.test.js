...
const bundle = await build({
  stdin: { contents: source + '\nglobalThis.runtimeTest = { exportObservations, feigua, kuaishou, bilibili, bilibiliPopular, initialize, watchdog, setPaused, stopRun, configureOpenTabSidePanels, flushOutbox, handleUploadAlarm, resumeRun, state: () => state };', resolveDir: root, loader: 'js' },
