...
test('restoring a Feigua collection in local test mode keeps new results local',async()=>{
...
test('Feigua browse uses saved rules and persists the same conclusions to history and upload payload',async()=>{
 const w=await worker({draSettings:{dryRun:false,feiguaUploadEnabled:true,schedule:{enabled:false}}});
