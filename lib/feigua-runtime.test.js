...
async function runFixture({ pause=false, frozen=false, blocked=false, settings={}, pauseWait=false, imagesUntil=0, changingUntil=0, incompleteUntil=0, loadingAfter=null, badPages=[], totalPages=2, freezeClicks=0, pauseOnTimeout=false, missingPager=false, loadingPages=[] }={}) {
 ...
 return {clicks,messages,page,delays,reveals:context.fixture.reveals||0};
}
