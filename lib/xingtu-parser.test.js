...
test('达人详情从星图 ID 邻近文本读取达人名，不误用导航中的企业账号', () => {
  const raw = '我的星图\n找达人\n转 转转-青岛第二分公司-7\n通用短视频主页\n\n八零徐姥姥（22号早8点稻田河蟹专场）\n星图ID: 7261082806409756709\n粉丝\n1,475w';
  assert.equal(core.extractXingtuDetailName(raw, '7261082806409756709'), '八零徐姥姥（22号早8点稻田河蟹专场）');
  assert.equal(core.extractXingtuDetailName(raw, '123'), '');
});
