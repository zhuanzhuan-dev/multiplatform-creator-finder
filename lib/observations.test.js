...
import {normalizeFeiguaObservation,normalizeXingtuObservation,mergeObservations,observationRecord,xingtuObservationRecord} from './observations.js';
...
test('normalizes Xingtu market cards without inventing Douyin identity',()=>{
 ...
 const author={authorName:'乙',xingtuId:'987654',profileUrl:'https://www.xingtu.cn/ad/creator/author/douyin/987654',followerCount:'12.6w',tags:['美食'],prices:{'1-20s':'800'},rawText:'乙'};
 ...
 assert.equal(record.rpa_feedback.xingtu_id,'987654');assert.equal(record.author_href,'');
});
